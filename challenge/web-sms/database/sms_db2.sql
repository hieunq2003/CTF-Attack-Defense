...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 18, 2025 lúc 05:48 PM
...
INSERT INTO `backups` (`id`, `stored_filename`, `display_name`, `created_at`) VALUES
(1, 'initial_backup.sql', 'Initial System Backup', '2025-11-18 16:35:03');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `back_order_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `back_order_list`
--
...
--
-- Cấu trúc bảng cho bảng `bo_items`
--
...
--
-- Đang đổ dữ liệu cho bảng `bo_items`
--
...
--
-- Cấu trúc bảng cho bảng `item_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `item_list`
--
...
--
-- Cấu trúc bảng cho bảng `po_items`
--
...
--
-- Đang đổ dữ liệu cho bảng `po_items`
--
...
--
-- Cấu trúc bảng cho bảng `purchase_order_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `purchase_order_list`
--
...
--
-- Cấu trúc bảng cho bảng `receiving_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `receiving_list`
--
...
--
-- Cấu trúc bảng cho bảng `return_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `return_list`
--
...
--
-- Cấu trúc bảng cho bảng `sales_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `sales_list`
--
...
--
-- Cấu trúc bảng cho bảng `stock_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `stock_list`
--
...
--
-- Cấu trúc bảng cho bảng `supplier_list`
--
...
--
-- Đang đổ dữ liệu cho bảng `supplier_list`
--
...
--
-- Chỉ mục cho bảng `back_order_list`
--
...
--
-- Chỉ mục cho bảng `purchase_order_list`
--
...
--
-- Chỉ mục cho bảng `receiving_list`
--
ALTER TABLE `receiving_list`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `return_list`
--
...
--
-- Chỉ mục cho bảng `sales_list`
--
ALTER TABLE `sales_list`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `stock_list`
--
...
--
-- Chỉ mục cho bảng `supplier_list`
--
...
--
-- AUTO_INCREMENT cho bảng `back_order_list`
--
ALTER TABLE `back_order_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `item_list`
--
ALTER TABLE `item_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `purchase_order_list`
--
ALTER TABLE `purchase_order_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `receiving_list`
--
ALTER TABLE `receiving_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `return_list`
--
ALTER TABLE `return_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `sales_list`
--
ALTER TABLE `sales_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `stock_list`
--
ALTER TABLE `stock_list`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT cho bảng `supplier_list`
--
ALTER TABLE `supplier_list`
...
--
-- Các ràng buộc cho bảng `back_order_list`
--
ALTER TABLE `back_order_list`
...
--
-- Các ràng buộc cho bảng `bo_items`
--
ALTER TABLE `bo_items`
