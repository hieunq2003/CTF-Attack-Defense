...
#Them penalty
@admin.register(models.Penalty, site=admin_site)
class PenaltyAdmin(admin.ModelAdmin):

    list_display = ('id', 'team', 'service', 'value', 'is_active', 'reason', 'created_at')
    list_filter = ('service', 'team', 'is_active', 'created_at')
    search_fields = (
