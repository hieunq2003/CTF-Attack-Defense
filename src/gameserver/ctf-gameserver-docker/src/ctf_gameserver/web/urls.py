...
#Thêm template cho home
#from django.views.generic import TemplateView

# pylint: disable=invalid-name
#them surilog
from .surilogs import views as surilogs_views
...
urlpatterns = [
    ...
    #Them suricatalog
    url(r'^admin/suricata/fastlog/$', surilogs_views.fastlog_view, name='fastlog'),
    url(r'^admin/suricata/fastlog/stream/$', surilogs_views.fastlog_stream, name='fastlog_stream'),
    url(r'^admin/suricata/fastlog/history/$', surilogs_views.fastlog_history, name='fastlog_history'),
...
#    url(r'^$', TemplateView.as_view(template_name="home.html"), name="custom_home"),
    url(r'^(?P<slug>[\w-]+)/$',
        flatpages_views.flatpage,
